...
.macro SPPF _1
    .byte ((_1 - SPPF_Table + 4) / 2)	; The offsets 
	.endm
...
.macro CBIG_BCOff _1
	.byte _1 - Chng4Way_90Degrees
	.endm

	; Get initial offset to proper set of commands to be used
CBig_Offsets:
	CBIG_BCOff(Chng4Way_90Degrees)	; 4-way cannon at 90 degrees
	CBIG_BCOff(Chng4Way_45Degrees)	; 4-way cannon at 45 degrees

	CBIG_BCOff(CBig_GiantBlock_BrickBust)	; GiantBlock_BrickBust
	CBIG_BCOff(CBig_GiantBlock_BlockHit)	; GiantBlock_BlockHit
	CBIG_BCOff(CBig_GiantBlock_BrickRestore)	; GiantBlock_BrickRestore
