...
LevelAnimPages:
    ...
    .byte 138, 140, 142, 144	; Off (on/off switched off)
...
PRG030_8DF4:
    LDA Level_TimerEn
    BMI _PRG030_8E1A     ; If bit 7 is set (animations disabled), jump to PRG030_8E2E
...
PRG030_9F0D:
    ...
    .include custom/para_boss/update_setup.asm
