...
.macro MusSeg _1, _2, _3, _4, _5, _6
   .word _1	; Rest array pointer
   .word _2	; Address of music segment square wave data (sq1 offset in following byte)
   .byte _3	; Square 1 track starting offset
   .word _4	; Triangle track pointer
   .word _5	; Noise track pointer
   .word _6	; DCM track pointer
