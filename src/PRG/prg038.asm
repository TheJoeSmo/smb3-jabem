...
.macro MSHO _1
    .byte _1-Sound_Map_LUT    ; "Map Sound Header Offset"
    .endm
Sound_Map_LUT:
    ; These are offsets from here to the respective SFX data headers
    MSHO(SndMapH_Entrance)
    MSHO(SndMapH_Move)
    MSHO(SndMapH_Enter)
    MSHO(SndMapH_Flip)
    MSHO(SndMapH_Bonus)
...
SndMapH_Entrance:    MSO(SndMap_Data_WEnt)
                     .byte $00 ; $01: World begin starry entrance sound
SndMapH_Move:        MSO(SndMap_Data_Move),
                     .byte $00 ; $02: Path move
SndMapH_Enter:       MSO(SndMap_Data_Entr)
                     MSO(SndMap_Data_Entr2) ; $04: Enter level
SndMapH_Flip:        MSO(SndMap_Data_Flip)
                     .byte $00 ; $08: Flip inventory
SndMapH_Bonus:       MSO(SndMap_Data_Bonus)
                     .byte $00 ; $10: Bonus appears
SndMapH_Deny:        MSO(SndMap_Data_Deny)
                     .byte $00 ; $80: Denied
SndMapH_Unused:      MSO(SndMap_Data_Unused)
                     .byte $00 ; $20/$40: ?? unused ?
...
.macro MusSeg _1, _2, _3, _4, _5, _6, _7
    .byte _1    ; bank
    .word _2    ; Rest array pointer
    .word _3    ; Address of music segment square wave data (sq1 offset in following byte)
    .byte _4    ; Square 1 track starting offset
    .word _5    ; Triangle track pointer
    .word _6    ; Noise track pointer
    .word _7    ; DCM track pointer
